...
std::string toString(Token::Type type) {
    switch (type) {
        ...
        case Token::Type::Field: return "Field";
        case Token::Type::Method: return "Method";
        case Token::Type::Instance: return "Instance";
...
std::string toSourceString(Token::Type type) {
    switch (type) {
        ...
        case Token::Type::Struct: return "crew";
        case Token::Type::Field: return "packing";
        case Token::Type::Method: return "hustle";
        case Token::Type::Instance: return "recruit";
